# WhaDay App Store Paketi

Bu dosya App Store Connect'te kullanılacak metinlerin kaynak belgesidir. Ana dil Türkçe, ikincil yerelleştirme İngilizcedir.

## Konumlandırma

- Ana vaat: Her gün paylaşmaya değer küçük bir keşif.
...
- Gelir modeli (1.0): Ücretsiz, reklamsız, hesap gerektirmez.
...
**Alt başlık**  
Her gün paylaşacak bir şey

**Promosyon metni**  
Bugünün ne günü olduğunu keşfet; aklına gelen kişiye tek dokunuşla gönder. Her gün yeni bir bahane, her paylaşımda küçük bir bağ.

**Anahtar kelimeler**  
takvim,ozel gun,story,paylasim,hatirlatici,bilgi,sosyal,arkadas,gunluk
...
**Subtitle**  
A reason to share every day

**Promotional text**  
Discover what today is about, think of someone, and send them a beautifully designed card. A tiny daily discovery made to start real conversations.

**Keywords**  
calendar,daily,holidays,story,share,facts,reminder,friends,social,observances
