...
styles. It does not request contact access, require an account, or contain any advertising
SDK. The optional one-time WhaDay+ purchase unlocks two additional share appearances.
